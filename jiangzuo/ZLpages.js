...
*/
  function goPage(pno,psize,m,Goto){
	...
	var pageSize = psize;//每页显示行数
        ...
        if(num<=pageSize){
                document.getElementById("barcon_"+m).innerHTML ="<p>一共 "+num+" 条</p>";
   		return false;
        }
	...
	var tempStr = "<p><a class=\"a1\" href=\"#\" target=\"_self\">"+(num)+"条</a> ";
	if(currentPage>1){
	...
	if(currentPage<totalPage){
		...
		tempStr += "<a class=\"a1\" href=\"#\" target=\"_self\">下一页</a></p>";	
	}
